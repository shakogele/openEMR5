                    ...
                    <fieldset>
                        ...
                        if (!empty($check_res)) {
                            foreach ($check_res as $key => $obj) { ?>
                                <div class = "tb_row" id="tb_row_<?php echo attr($key) + 1; ?>" style="padding: 20px 0px;
    border-bottom: 3px solid teal;">
                                    ...
                                    padding: 10px;">
                                      ...
                                      <tbody>
                                        ...
                                        <th style="text-align: left; width: 10%; padding: 10px;border: 1px solid teal;">ms/gl</th>
                                        ...
                                        <th style="text-align: left; width: 10%; padding: 10px;border: 1px solid teal;"><?php echo attr($obj{"ob_value"}); ?></th>
                                        <th style="text-align: left; width: 10%; padding: 10px;border: 1px solid teal;"><?php echo attr($obj{"ob_value"}); ?></th>
                                      </tbody>
                                    </table>
                                </div>
